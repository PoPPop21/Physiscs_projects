...
{
  outputFile.open("event_data.csv", std::ios::out); // sobrescribe cada corrida
  if (!outputFile.is_open()) G4Exception("EventAction","001",FatalException,"Cannot open output file");
}
